...
The models are broadly categorised into the folders [vision](/vision) (e.g. large **C**onvolutional **N**eural **N**etworks), [text](/text) (e.g. various **R**ecurrent **N**eural **N**etworks and **N**atural **L**anguage **P**rocessing models), [games](/games) (**R**einforcement **L**earning). See the READMEs of respective models for more information.
