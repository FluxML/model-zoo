...
ResNet = StandardResnet(BasicBlock, [2, 2, 2, 2])
# ResNet = StandardResnet(BasicBlock, [3, 4, 6, 3])
# ResNet = StandardResnet(Bottleneck, [3, 4, 6, 3])
# ResNet = StandardResnet(Bottleneck, [3, 4, 23, 3])
# ResNet = StandardResnet(Bottleneck, [3, 8, 36, 3])
