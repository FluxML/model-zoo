...
# This file is very similar to the example [neural_ode.jl](https://github.com/FluxML/model-zoo/blob/master/other/diffeq/neural_ode.jl), but adds a model that is trained using tangent-space regularization to promote a smooth dynamics function.
