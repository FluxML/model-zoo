...
function Mixed_5b()
    ...
    branch2 = Chain(ConvBlock((1, 1), 192=>48),
                    ConvBlock((5, 5), 48=>64, pad = (2, 2)))

    branch3 = Chain(ConvBlock((1, 1), 192=>64),
                    ConvBlock((3, 3), 64=>96, pad = (1, 1)),
                    ConvBlock((3, 3), 96=>96, pad = (1, 1)))

    branch4 = Chain(x -> meanpool(x, (3, 3), stride = (1, 1), pad = (1, 1)),
...
function Mixed_7a()
    branch1 = Chain(ConvBlock((1, 1), 1088=>256),
                    ConvBlock((3, 3), 256=>384, stride = (2, 2)))

    branch2 = Chain(ConvBlock((1, 1), 1088=>256),
                    ConvBlock((3, 3), 256=>288, stride = (2, 2)))

    branch3 = Chain(ConvBlock((1, 1), 1088=>256),
                    ConvBlock((3, 3), 256=>288, pad = (1, 1)),
                    ConvBlock((3, 3), 288=>320, stride = (2, 2)))

    branch4 = x -> maxpool(x, (3, 3), stride = (2, 2))

    Mixed_5b_7a(branch1, branch2, branch3, branch4)
end

(m::Mixed_5b_7a)(x) = cat(3, m.branch1(x), m.branch2(x), m.branch3(x), m.branch4(x))
...
function Block35(scale = 1.0f0)
    ...
    branch2 = Chain(ConvBlock((1, 1), 320=>32),
                    ConvBlock((3, 3), 32=>32, pad = (1, 1)))

    branch3 = Chain(ConvBlock((1, 1), 320=>32),
...
(b::Block35)(x) = relu.(b.convlayer(cat(3, b.branch1(x), b.branch2(x), b.branch3(x))) * b.scale + x)
...
function Mixed_6a()
    ...
    branch2 = Chain(ConvBlock((1, 1), 320=>256),
...
(m::Mixed_6a)(x) = cat(3, m.branch1(x), m.branch2(x), m.branch3(x))
...
function Block17(scale = 1.0f0)
    ...
    branch2 = Chain(ConvBlock((1, 1), 1088=>128),
...
(b::Block17)(x) = relu.(b.convlayer(cat(3, b.branch1(x), b.branch2(x))) * b.scale + x)
...
function Block8(scale = 1.0f0, norelu = false)
    ...
    branch2 = Chain(ConvBlock((1, 1), 2080=>192),
...
function (b::Block8)(x)
    ẋ = b.convlayer(cat(3, b.branch1(x), b.branch2(x))) * b.scale + x
    if(!b.norelu)
        ẋ = relu.(ẋ)
    end
    ẋ
